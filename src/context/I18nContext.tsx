...
const translations = {
  en: {
    ...
    'settings.upiType': 'UPI Account Type',
    'settings.upiTypeMerchant': 'Merchant Account (auto-fills amount)',
    'settings.upiTypePersonal': 'Personal Account (requires customer to enter amount manually)',
  ...
  te: {
    ...
    'settings.upiType': 'UPI ఖాతా రకం',
    'settings.upiTypeMerchant': 'మర్చంట్ ఖాతా (ఆటోమేటిక్‌గా మొత్తం నింపబడుతుంది)',
    'settings.upiTypePersonal': 'వ్యక్తిగత ఖాతా (కస్టమర్ మొత్తాన్ని మాన్యువల్‌గా నమోదు చేయాలి)',
  ...
  hi: {
    ...
    'settings.upiType': 'UPI खाता प्रकार',
    'settings.upiTypeMerchant': 'मर्चेंट खाता (राशि स्वचालित रूप से भर जाती है)',
    'settings.upiTypePersonal': 'व्यक्तिगत खाता (ग्राहक को मैन्युअल रूप से राशि दर्ज करनी होगी)',
